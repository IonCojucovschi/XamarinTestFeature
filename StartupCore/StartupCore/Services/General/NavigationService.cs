    ...
    public class NavigationService : INavigationService
    {
        ...
        protected virtual async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            else if (CurrentApplication.MainPage is MainView)
            {
                ...
                if (mainPage.Detail is StartupNavigationPage navigationPage)
                {
            ...
            {
                var navigationPage = CurrentApplication.MainPage as StartupNavigationPage;
                ...
                {
                    CurrentApplication.MainPage = new StartupNavigationPage(page);
                }
            }
